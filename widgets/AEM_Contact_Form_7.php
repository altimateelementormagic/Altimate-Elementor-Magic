 ...
 */
class AEM_Contact_Form_7 extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Contact Form 7', AEM_TEXTDOMAIN );
    }
    ...
    public function get_icon() {
        return 'aem aem-logo eicon-envelope';
    }
    ...
    protected function register_controls() {
            ...
            $this->add_control(
                ...
                [
                    ...
                    'raw'             => __('<strong>contact Form 7</strong> is not installed/activated on your site. Please install and activate <a href="plugin-install.php?s=contact+form+7&tab=search&type=term" target="_blank">Contact Form 7</a> first.',
                        AEM_TEXTDOMAIN),
                    'content_classes' => 'aem-panel-notice',
                ]
            );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'show',
                'options' => [
                    'show' => __( 'Show', AEM_TEXTDOMAIN ),
                    'hide' => __( 'Hide', AEM_TEXTDOMAIN )
                ],
                ...
                'selectors' => [
                    '{{WRAPPER}} .aem-contact-form-7 .wpcf7-not-valid-tip' => 'display: {{VALUE}} !important;'
                ]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .aem-contact-form-7 .wpcf7-validation-errors' => 'display: {{VALUE}} !important;'
                ]
            ]
        );
        ...
        $this->add_group_control(
  		...
  		$this->add_responsive_control(
  			...
  			[
				...
				'selectors'  => [
					'{{WRAPPER}} .aem-contact-form' => 'width: {{SIZE}}{{UNIT}};'
				]
  			]
  		);
		...
		$this->add_responsive_control(
			...
			[
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors'  => [
					'{{WRAPPER}} .aem-contact-form' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				],
                'default'    => [
                    'top'    => 40,
                    'right'  => 40,
        ...
        $this->add_responsive_control(
			...
			[
                ...
                'size_units' => [ 'px', '%' ],
                'selectors'  => [
					'{{WRAPPER}} .aem-contact-form' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				],
                'default'    => [
                    'top'    => 0,
                    'right'  => 0,
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .aem-contact-form' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				]
			]
		);
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .aem-contact-form-7 .aem-contact-form-7-title' => 'color: {{VALUE}}'
                ]
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'     => [
                    '{{WRAPPER}} .aem-contact-form-7 .aem-contact-form-7-title' => 'text-align: {{VALUE}};'
                ]
            ]
        );
        ...
        $this->add_responsive_control(
			...
			[
                ...
                'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .aem-contact-form-7 .aem-contact-form-7-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				]
			]
		);
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Input & Textarea', AEM_TEXTDOMAIN ),
                'tab'   => Controls_Manager::TAB_STYLE
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '#EDEDED',
                'selectors' => [
                    '{{WRAPPER}} .aem-contact-form-7 .wpcf7-form-control.wpcf7-text, {{WRAPPER}} .aem-contact-form-7 .wpcf7-form-control.wpcf7-textarea, {{WRAPPER}} .aem-contact-form-7 .wpcf7-form-control.wpcf7-select' => 'background-color: {{VALUE}}'
                ]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .aem-contact-form-7 .wpcf7-form-control.wpcf7-text, {{WRAPPER}} .aem-contact-form-7 .wpcf7-form-control.wpcf7-textarea, {{WRAPPER}} .aem-contact-form-7 .wpcf7-form-control.wpcf7-select' => 'color: {{VALUE}}'
                ]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .aem-contact-form-7 input[type="text"]::placeholder,
                        {{WRAPPER}} .aem-contact-form-7 input[type="email"]::placeholder,
                        {{WRAPPER}} .aem-contact-form-7 input[type="url"]::placeholder,
                        {{WRAPPER}} .aem-contact-form-7 input[type="password"]::placeholder,
                        {{WRAPPER}} .aem-contact-form-7 input[type="search"]::placeholder,
                        {{WRAPPER}} .aem-contact-form-7 input[type="number"]::placeholder,
                        {{WRAPPER}} .aem-contact-form-7 input[type="tel"]::placeholder,
                        {{WRAPPER}} .aem-contact-form-7 input[type="range"]::placeholder,
                        {{WRAPPER}} .aem-contact-form-7 input[type="date"]::placeholder,
                        {{WRAPPER}} .aem-contact-form-7 input[type="month"]::placeholder,
                        {{WRAPPER}} .aem-contact-form-7 input[type="week"]::placeholder,
                        {{WRAPPER}} .aem-contact-form-7 input[type="time"]::placeholder,
                        {{WRAPPER}} .aem-contact-form-7 input[type="datetime"]::placeholder,
                        {{WRAPPER}} .aem-contact-form-7 input[type="datetime-local"]::placeholder,
                        {{WRAPPER}} .aem-contact-form-7 input[type="color"]::placeholder,
                        {{WRAPPER}} .aem-contact-form-7 textarea::placeholder' => 'color: {{VALUE}};'
                ]
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .aem-contact-form-7 input[type="text"],
                        ...
                        {{WRAPPER}} .aem-contact-form-7 input[type="password"],
                        {{WRAPPER}} .aem-contact-form-7 input[type="search"],
                        {{WRAPPER}} .aem-contact-form-7 input[type="number"],
                        {{WRAPPER}} .aem-contact-form-7 input[type="tel"],
                        {{WRAPPER}} .aem-contact-form-7 input[type="range"],
                        {{WRAPPER}} .aem-contact-form-7 input[type="date"],
                        {{WRAPPER}} .aem-contact-form-7 input[type="month"],
                        {{WRAPPER}} .aem-contact-form-7 input[type="week"],
                        {{WRAPPER}} .aem-contact-form-7 input[type="time"],
                        {{WRAPPER}} .aem-contact-form-7 input[type="datetime"],
                        {{WRAPPER}} .aem-contact-form-7 input[type="datetime-local"],
                        {{WRAPPER}} .aem-contact-form-7 input[type="color"],
                        {{WRAPPER}} .aem-contact-form-7 textarea'
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'    => [
                    '{{WRAPPER}} .aem-contact-form-7 input[type="text"],
                    {{WRAPPER}} .aem-contact-form-7 input[type="email"],
                    {{WRAPPER}} .aem-contact-form-7 input[type="url"],
                    {{WRAPPER}} .aem-contact-form-7 input[type="password"],
                    {{WRAPPER}} .aem-contact-form-7 input[type="search"],
                    ...
                    {{WRAPPER}} .aem-contact-form-7 input[type="datetime"],
                    {{WRAPPER}} .aem-contact-form-7 input[type="datetime-local"],
                    {{WRAPPER}} .aem-contact-form-7 input[type="color"]' => 'height: {{SIZE}}px;'
                ]
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'    => [
                    '{{WRAPPER}} .aem-contact-form-7 textarea' => 'height: {{SIZE}}px;'
                ]
            ]
        );
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .aem-contact-form-7 .wpcf7-form-control.wpcf7-text, {{WRAPPER}} .aem-contact-form-7 .wpcf7-form-control.wpcf7-textarea' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				]
			]
		);
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors'  => [
                    '{{WRAPPER}} .aem-contact-form-7 input, {{WRAPPER}} .aem-contact-form-7 textarea' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ],
                'default'    => [
                    'top'    => 10,
                    'right'  => 0,
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'     => [
                    '{{WRAPPER}} .aem-contact-form-7 .wpcf7-form-control.wpcf7-text, {{WRAPPER}} .aem-contact-form-7 .wpcf7-form-control.wpcf7-textarea' => 'width: {{SIZE}}{{UNIT}}'
                ]
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'    => [
                    ...
                    {{WRAPPER}} .aem-contact-form-7 input[type="datetime-local"],
                    {{WRAPPER}} .aem-contact-form-7 textarea,
                    {{WRAPPER}} .aem-contact-form-7 input[type="color"]' => 'margin-bottom: {{SIZE}}px;'
                ]
            ]
        );
		...
		$this->add_responsive_control(
			...
			[
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors'  => [
					'{{WRAPPER}} .aem-contact-form-7 .wpcf7-form-control.wpcf7-text, {{WRAPPER}} .aem-contact-form-7 .wpcf7-form-control.wpcf7-textarea' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				]
			]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .aem-contact-form-7 .wpcf7-form label' => 'color: {{VALUE}}'
                ]
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type'    => Controls_Manager::SELECT,
                'options' => [
					'left'  => __( 'Button Left', AEM_TEXTDOMAIN ),
					'center'  => __( 'Button Center', AEM_TEXTDOMAIN ),
					'right'  => __( 'Button Right', AEM_TEXTDOMAIN ),
					'justify'  => __( 'Button Justify', AEM_TEXTDOMAIN ),
				],
                ...
                'selectors'     => [
                    '{{WRAPPER}} .aem-contact-form-7 .wpcf7-form input[type="submit"]' => '{{VALUE}};'
                ]
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors'  => [
                    '{{WRAPPER}} .aem-contact-form-7 .wpcf7-form input[type="submit"]' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ],
                'default'    => [
                    'top'    => 0,
                    'right'  => 0,
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors'  => [
                    '{{WRAPPER}} .aem-contact-form-7 .wpcf7-form input[type="submit"]' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ],
                'default'      => [
                    'top'      => 20,
                    'right'    => 50,
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'     => [
                    '{{WRAPPER}} .aem-contact-form-7 .wpcf7-form input[type="submit"]' => 'margin-top: {{SIZE}}{{UNIT}};'
                ]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '#ffffff',
                'selectors' => [
                    '{{WRAPPER}} .aem-contact-form-7 .wpcf7-form input[type="submit"]' => 'color: {{VALUE}}'
                ]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '#ffffff',
                'selectors' => [
                    '{{WRAPPER}} .aem-contact-form-7 .wpcf7-form input[type="submit"]:hover' => 'background-color: {{VALUE}}'
                ]
            ]
        );
    ...
    protected function render() {
        ...
        $this->add_render_attribute( 'aem-contact-form', 'class', [
				'aem-contact-form',
				'aem-contact-form-7',
                'aem-contact-form-'.esc_attr($this->get_id())
			]
		);
