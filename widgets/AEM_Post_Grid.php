...
class AEM_Post_Grid extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->start_controls_tabs( 'goee_post_grid_category_tabs' );
            ...
            // normal state tab
			$this->start_controls_tab( 'goee_post_grid_odd_category', [ 'label' => esc_html__( 'ODD', AEM_TEXTDOMAIN ) ] );
            ...
            // hover state tab
			$this->start_controls_tab( 'goee_post_grid_even_category', [ 'label' => esc_html__( 'Even', AEM_TEXTDOMAIN ) ] );
        ...
        $this->start_controls_tabs( 'goee_post_grid_details_button_style_tabs' );
            ...
            // normal state tab
            $this->start_controls_tab( 'goee_post_grid_details_btn_normal', [ 'label' => esc_html__( 'Normal', AEM_TEXTDOMAIN ) ] );
            ...
            // hover state tab
            $this->start_controls_tab( 'goee_post_grid_details_btn_hover', [ 'label' => esc_html__( 'Hover', AEM_TEXTDOMAIN ) ] );
		...
		$this->start_controls_tabs( 'goee_post_grid_load_more_btn_tabs' );
            ...
            // normal state tab
			$this->start_controls_tab( 'goee_post_grid_load_more_btn_normal', [ 'label' => esc_html__( 'Normal', AEM_TEXTDOMAIN ) ] );
            ...
            // hover state tab
			$this->start_controls_tab( 'goee_post_grid_load_more_btn_Hover', [ 'label' => esc_html__( 'Hover', AEM_TEXTDOMAIN ) ] );
	...
	protected function render() {
		...
		if( 'yes' === $settings['goee_post_grid_enable_featured_post'] ){
			$this->add_render_attribute(
				'goee_post_grid_featured_post',
				[
					'class' => ['aem-post-grid-featured-post-'.$settings['goee_post_grid_enable_featured_post'], $settings['goee_post_grid_feature_post_layout']]
				]
			);
		}
		...
		<div <?php echo $this->get_render_attribute_string( 'goee_post_grid_featured_post' ); ?>>
			...
			<div class="aem-post-grid-load-btn">
				<?php if( 'yes' === $settings['goee_post_grid_enable_load_more_btn'] ) { ?>
					<a class="aem-post-grid-paginate-btn" <?php echo $this->get_render_attribute_string( 'goee_post_grid_load_more_button' ); ?> href="#" role="button">
