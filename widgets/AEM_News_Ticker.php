...
class AEM_News_Ticker extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'aem_news_ticker_animation_direction',
            [
        ...
        $this->add_control(
            'aem_news_ticker_set_fixed_position',
            [
                'type'         => Controls_Manager::SELECT,
        ...
        $this->add_control(
            'aem_news_ticker_animation_type',
            [
        ...
        $this->add_control(
            'aem_news_ticker_autoplay_interval',
            [   
                'label'         => esc_html__( 'Autoplay Interval', AEM_TEXTDOMAIN ),
                'type'          => Controls_Manager::NUMBER,
                'default'       => '4000',
                'condition'     => [
                    '.aem_news_ticker_animation_type!' => 'scroll'
                ]              
            ]
        ); 

        $this->add_control(
            'aem_news_ticker_animation_speed',
            [   
        ...
        $this->add_control(
            'aem_news_ticker_pause_on_hover',
            [
                'type'         => Controls_Manager::SWITCHER,
                ...
                'return_value' => 'yes',
                'condition'    => [
                    '.aem_news_ticker_autoplay' => 'yes'
                ]                
            ]
        );

        $this->add_control(
            'aem_news_ticker_show_label',
            [
                'type'         => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            'aem_news_ticker_show_label_arrow',
            [
                'type'         => Controls_Manager::SWITCHER,
                ...
                'return_value' => 'yes',
                'condition'    => [
                    'aem_news_ticker_show_label' => 'yes'
                ]
            ]
        );

        $this->add_control(
            'aem_news_ticker_show_label_icon',
            [
                'type'         => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            'aem_news_ticker_show_pause_control',
            [
                'type'         => Controls_Manager::SWITCHER,
                ...
                'return_value' => 'yes',
                'condition'    => [
                    'aem_news_ticker_show_controls' => 'yes'
                ]
            ]
        );         

        $this->add_control(
            'aem_news_ticker_label_icon',
            [
                ...
                'condition'   => [
                    'aem_news_ticker_show_label'      => 'yes',
                    'aem_news_ticker_show_label_icon' => 'yes'
                ]
            ]
        ); 
        ...
        $this->start_controls_section(
            'aem_news_ticker_container_style',
            [
        ...
        $this->add_group_control(
            ...
            [
                'name'      => 'aem_news_ticker_container_bg_color',
        ...
        $this->add_group_control(
            ...
            [
                'name'           => 'aem_news_ticker_container_border',
                'selector'       => '{{WRAPPER}} .aem-news-ticker',
                'fields_options' => [
                    'border'      => [
                        'default' => 'solid'
        ...
        $this->add_responsive_control(
            'aem_news_ticker_container_border_radius',
            [
        ...
        $this->add_group_control(
            ...
            [
                'name'     => 'aem_news_ticker_container_box_shadow',
                'selector' => '{{WRAPPER}} .aem-news-ticker'
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'name'     => 'aem_news_ticker_label_typography',
                'selector' => '{{WRAPPER}} .aem-news-ticker .aem-bn-label'
            ]
        );

        $this->add_control(
            'aem_news_ticker_label_color',
            [
        ...
        $this->add_group_control(
            Group_Control_Background::get_type(),
            [
                'name'      => 'aem_news_ticker_label_bg_color',
                'types'     => [ 'classic', 'gradient' ],
        ...
        $this->add_group_control(
            Group_Control_Border::get_type(),
            [
                'name'           => 'aem_news_ticker_label_border',
                'selector'       => '{{WRAPPER}} .aem-news-ticker .aem-bn-label',
                'fields_options' => [
                    'border'      => [
                        'default' => 'solid'
        ...
        $this->add_responsive_control(
            'aem_news_ticker_label_border_radius',
            [
                'label'      => esc_html__( 'Border Radius', AEM_TEXTDOMAIN ),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px'],
        ...
        $this->add_control(
            'aem_news_ticker_label_icon_style',
            [
                ...
                'condition' => [
                    'aem_news_ticker_show_label_icon'    => 'yes',
                    'aem_news_ticker_label_icon[value]!' => ''
                ]
            ]
        );

        $this->add_responsive_control(
            'aem_news_ticker_label_icon_size',
            [
        ...
        $this->add_control(
            'aem_news_ticker_label_icon_color',
            [
        ...
        $this->add_responsive_control(
            'aem_news_ticker_label_icon_padding',
            [
        ...
        $this->add_responsive_control(
            'aem_news_ticker_each_item_padding',
            [
        ...
        $this->add_group_control(
            Group_Control_Border::get_type(),
            [
                'name'     => 'aem_news_ticker_items_border',
                'selector' => '{{WRAPPER}} .aem-news-ticker .aem-nt-news'
            ]
        );

        $this->add_responsive_control(
            'aem_news_ticker_items_border_radius',
            [
                'label'      => esc_html__( 'Border Radius', AEM_TEXTDOMAIN ),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px'],
        ...
        $this->add_responsive_control(
			'aem_news_ticker_control_spacing',
			[
        ...
        $this->add_control(
            'aem_news_ticker_control_box_style',
            [
        ...
        $this->add_control(
            'aem_news_ticker_control_bg_color',
            [
                'label'     => esc_html__( 'Background Color', AEM_TEXTDOMAIN ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#ffffff',
        ...
        $this->add_group_control(
            Group_Control_Border::get_type(),
            [
                'name'     => 'aem_news_ticker_controls_box_border',
                'selector' => '{{WRAPPER}} .aem-news-ticker .aem-nt-controls'
            ]
        );

        $this->add_responsive_control(
            'aem_news_ticker_controls_box_border_radius',
            [
                'label'      => esc_html__( 'Border Radius', AEM_TEXTDOMAIN ),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px'],
        ...
        $this->add_control(
            'aem_news_ticker_control_box_item_style',
            [
        ...
        $this->add_responsive_control(
			'aem_news_ticker_control_item_spacing',
			[
        ...
        $this->start_controls_tabs( 'aem_news_ticker_controls_tabs' );

            # Normal State Tab
            $this->start_controls_tab( 'aem_news_ticker_controls_normal', [ 'label' => esc_html__( 'Normal', AEM_TEXTDOMAIN ) ] );
                $this->add_control(
                    'aem_news_ticker_controls_color',
                    [
                ...
                $this->add_control(
                    'aem_news_ticker_controls_bg_color',
                    [
                        'label'     => esc_html__( 'Background Color', AEM_TEXTDOMAIN ),
                        'type'      => Controls_Manager::COLOR,
                ...
                $this->add_group_control(
                    Group_Control_Border::get_type(),
                    [
                        'name'     => 'aem_news_ticker_control_items_border',
                        'selector' => '{{WRAPPER}} .aem-news-ticker .aem-nt-controls button'
                    ]
                );

                $this->add_responsive_control(
                    'aem_news_ticker_control_items_border_radius',
                    [
                        'label'      => esc_html__( 'Border Radius', AEM_TEXTDOMAIN ),
                        'type'       => Controls_Manager::DIMENSIONS,
                        'size_units' => [ 'px'],
            ...
            #Hover State Tab
            $this->start_controls_tab( 'aem_news_ticker_controls_hover', [ 'label' => esc_html__( 'Hover', AEM_TEXTDOMAIN ) ] );
                $this->add_control(
                    'aem_news_ticker_controls_hover_color',
                    [
                        'label'     => esc_html__( 'Icon Color', AEM_TEXTDOMAIN ),
                        'type'      => Controls_Manager::COLOR,
                        'default'   => '#999999',
                ...
                $this->add_control(
                    'aem_news_ticker_controls_bg_hover_color',
                    [
                        'label'     => esc_html__( 'Background Color', AEM_TEXTDOMAIN ),
                        'type'      => Controls_Manager::COLOR,
                        'default'   => 'rgba(0,0,0,0)',
                ...
                $this->add_group_control(
                    Group_Control_Border::get_type(),
                    [
                        'name'     => 'aem_news_ticker_control_items_hover_border',
                        'selector' => '{{WRAPPER}} .aem-news-ticker .aem-nt-controls button:hover'
                    ]
                );

                $this->add_responsive_control(
                    'aem_news_ticker_control_items_hover_border_radius',
                    [
                        'label'      => esc_html__( 'Border Radius', AEM_TEXTDOMAIN ),
                        'type'       => Controls_Manager::DIMENSIONS,
                        'size_units' => [ 'px'],
    ...
    protected function render() {
        ...
        $label          = $settings['aem_news_ticker_label'];
        $show_label     = $settings['aem_news_ticker_show_label'];
        $direction      = $settings['aem_news_ticker_animation_direction'];
        $ticker_height  = $settings['aem_news_ticker_height']['size'];
        $autoplay       = $settings['aem_news_ticker_autoplay'];
        $fixed_position   = $settings['aem_news_ticker_set_fixed_position'];
        $animation_type = $settings['aem_news_ticker_animation_type'];

        $arrow             = 'yes'    === $settings['aem_news_ticker_show_label_arrow'] ? ' yes-small' : ' no';
        $pause_on_hover    = 'yes'    === $autoplay ? $settings['aem_news_ticker_pause_on_hover'] : '';
        $animation_speed   = 'scroll' === $animation_type ? $settings['aem_news_ticker_animation_speed'] : '';
        $autoplay_interval = 'scroll' !== $animation_type ? $settings['aem_news_ticker_autoplay_interval'] : '';
        ...
        $this->add_inline_editing_attributes( 'aem_news_ticker_label', 'basic' );
        ?>
        <div <?php echo $this->get_render_attribute_string( 'aem-news-ticker-wrapper' );?>>
            <?php do_action( 'aem_news_ticker_wrapper_before' );
            if( 'yes' === $show_label ): ?>
                <div class="aem-bn-label <?php  echo esc_attr( $arrow ) ?>" >
                    <div class="aem-nt-label">
                    <?php if( 'yes' === $settings['aem_news_ticker_show_label_icon'] && !empty( $settings['aem_news_ticker_label_icon'] ) ){ ?>
                        <span class="aem-news-ticker-icon">
                            <?php Icons_Manager::render_icon( $settings['aem_news_ticker_label_icon'], [ 'aria-hidden' => 'true' ] );?>
                        </span>                               
                    <?php 
                    }
                    if( !empty( $label ) ) { ?>
                        <span <?php echo $this->get_render_attribute_string( 'aem_news_ticker_label' );?> ><?php echo wp_kses_post( $label ) ;?></span>
                    <?php } ?>
                    </div>
                </div>
            <?php endif;?>
            ...
            <div class="aem-nt-news">
                <?php if( is_array( $settings['aem_news_ticker_items'] ) ) : ?>
                    <ul>
                    <?php foreach ( $settings['aem_news_ticker_items'] as $key => $list ) :
                        $link_key  = 'link_' . $key;

                        $title = $this->get_repeater_setting_key( 'aem_news_ticker_title', 'aem_news_ticker_items', $key );
                        $this->add_inline_editing_attributes( $title, 'basic' );

                        if( $list['aem_news_ticker_link']['url'] ) :
                            $this->add_render_attribute( $link_key, 'href', esc_url( $list['aem_news_ticker_link']['url'] ) );
                            if( $list['aem_news_ticker_link']['is_external'] ) {
                                $this->add_render_attribute( $link_key, 'target', '_blank' );
                            }
                            if( $list['aem_news_ticker_link']['nofollow'] ) {
                                $this->add_render_attribute( $link_key, 'rel', 'nofollow' );
                            } ?>
                            <li>
                                <a <?php echo $this->get_render_attribute_string( $link_key );?> >
                                    <span <?php echo $this->get_render_attribute_string( $title );?> ><?php echo wp_kses_post( $list['aem_news_ticker_title'] );?></span>
                                </a>
                            </li>
                        <?php else : ?>
                            <li>
            ...
            <?php if ( 'yes' === $settings['aem_news_ticker_show_controls'] ) :?>
                <div class="aem-nt-controls">
                    <button><span class="bn-arrow bn-prev"></span></button>
                    <?php if( 'yes' === $settings['aem_news_ticker_show_pause_control'] ) :?>
                        <button><span class="bn-action"></span></button>
                    <?php endif;?>
                    <button><span class="bn-arrow bn-next"></span></button>
                </div>
            <?php endif;
            do_action( 'aem_news_ticker_wrapper_after' ); ?>
        </div>
    <?php 
    }
